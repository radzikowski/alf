...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/alf')) {
            // _alf
            if (rtrim($pathinfo, '/') === '/alf') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', '_alf');
                }
                return array (  '_controller' => 'Alf\\ShopBundle\\Controller\\ShopController::leftMenuAction',  '_route' => '_alf',);
            }
    
            // _alf_test
            if ($pathinfo === '/alf/test') {
                return array (  '_controller' => 'Alf\\ShopBundle\\Controller\\ShopController::testAction',  '_route' => '_alf_test',);
            }
